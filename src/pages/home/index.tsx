...
const defaultLayout = {
  lg: [
    { i: 'projetos', x: 0, y: 0, w: 4, h: 7, minW: 3, minH: 3 },
    { i: 'servicos_recorrentes', x: 4, y: 0, w: 4, h: 7, minW: 3, minH: 3 },
    { i: 'listas_tarefas', x: 8, y: 0, w: 4, h: 7, minW: 3, minH: 3 },
  ...
  md: [
    ...
    { i: 'listas_tarefas', x: 6, y: 0, w: 4, h: 6, minW: 3, minH: 3 },
  ...
  sm: [
    ...
    { i: 'listas_tarefas', x: 4, y: 0, w: 2, h: 6, minW: 2, minH: 3 },
  ...
  xxs: [
    ...
    { i: 'servicos_recorrentes', x: 0, y: 4, w: 2, h: 5, minW: 2, minH: 3 },
    { i: 'listas_tarefas', x: 0, y: 9, w: 2, h: 5, minW: 2, minH: 3 },
    { i: 'calendario', x: 0, y: 14, w: 2, h: 8, minW: 2, minH: 3 },
  ],
};
